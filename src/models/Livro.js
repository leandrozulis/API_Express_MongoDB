...
const livroSchema = new mongoose.Schema(
  {
    ...
    numeroPaginas: { type: Number, min: [10, "O número de páginas deve estar entra 10 e 5000. Valor fornecido: {VALUE}"], max: [5000, "O número de páginas deve estar entra 10 e 5000. Valor fornecido: {VALUE}"] }
  }
);
